	...
	class ARM_Report_Analytics 
	{
        ...
        function arm_all_user_login_history_page_paging_action() 
        {
            ...
            if (isset($_POST['action']) && ($_POST['action'] == 'arm_all_user_login_history_page_paging_action' || $_POST['action'] == 'arm_login_history_page_search_action')) 
            {
				...
				$posted_data['arm_login_history_page_search_user'] = !empty($_POST['arm_login_history_page_search_user']) ? sanitize_text_field( $_POST['arm_login_history_page_search_user'] ) : '';
            	$posted_data['arm_failed_login_filter'] = !empty($_POST['arm_failed_login_filter']) ? $_POST['arm_failed_login_filter'] : '';
                
                echo $this->arm_get_all_user_for_login_history_page($current_page, $per_page, $posted_data);
            }
            exit;
        }
