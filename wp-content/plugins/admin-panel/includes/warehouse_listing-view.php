...
<a class="back btn btn-primary" href="<?php echo admin_url('admin.php?page=warehouse_listing');?>">Back</a>
    </div>
...
<div class="bg-white p-0 rounded listing_table mt-4">  
 ...
 <div class="w-100 overflow-xscroll d-block rounded">
  <table id="warehouse_enterie" class="warehous_list mt-4 pt-0">
   <thead>
     <tr>
      <th>S no</th>
      <th>Warehouse ID</th>
...
//         jQuery(document).ready(function() {
//         jQuery('#warehouse_enterie').DataTable({
//         // "searching": false,
//         // "bPaginate": false,
//         // "bFilter": false,
//         // "order": [[ 0, "asc" ]],
