    ...
    class ARM_members_directory {
                        ...
                        foreach($arm_search_field_array as $key => $value)
                        {
                            ...
                            if($i == 1)
                            {
                                ...
                                if(empty($arm_default_directory_field_list[$key]) && !empty($searchStr)){
                                    $user_search .= $serach_operator." ( u.display_name LIKE '%{$searchStr}%' OR (um.meta_key = 'first_name' AND um.meta_value LIKE '%{$searchStr}%') OR (um.meta_key = 'last_name' AND um.meta_value LIKE '%{$searchStr}%') ) OR";
                                }
        ...
        function arm_get_membership_card_view($slug, $card_opts = '', $user_id = '', $user_info = '', $plan_info = '', $company_logo = '', $print = false, $frame_id = '', $display_avatar = 0, $card_background = '',$armpdf_status=0) {
            ...
            if( $slug == "membershipcard1" || $slug == "membershipcard2" ) {
                ...
                $card_html .= "<div class='arm_card_background arm_membership_card_template arm_membership_card_template_wrapper ".$rtl_site_class." ".$slug." arm_card_".$card_opts['arm_mcard_id']."' ".$card_size_style.">";
                ...
                if(!empty($company_logo)) { 
                    ...
                    $card_html .= "<div class='arm_card_left_logo arm_card_logo ".$rtl_site_class."' ".$card_logo_style.">";
