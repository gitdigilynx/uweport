...
$get_action = isset($_GET['action']) ? sanitize_text_field(  $_GET['action'] ) : 'add_profile'; 
?>
<div class="wrap arm_page arm_profiles_main_wrapper armPageContainer">
    ...
    <div class="content_wrapper arm_profiles_directories_container arm_min_height_500 arm_width_100_pct"  id="content_wrapper" style=" float:left;">
        ...
        <form name="arm_add_profile_temp_form" class="arm_add_profile_temp_form" id="arm_add_profile_temp_form" onSubmit="return false;" method="POST" action="#">
            ...
            <input type="hidden" name="arf_profile_action" id="arf_profile_action" value="<?php echo esc_attr($get_action); ?>" />
                                ...
                                <?php foreach ($fontOptions as $key => $value): ?>
                                    <div class="arm_temp_font_opts_box">
                                        ...
                                        <div class="arm_temp_font_opts">
                                            <input type="hidden" id="arm_template_font_family_<?php echo $key; ?>" name="template_options[<?php echo $key; ?>][font_family]" value="<?php echo (esc_attr($get_action) == 'edit_profile' && $options[$key]['font_family'] != '' ) ? $options[$key]['font_family'] : 'Poppins' ?> "/>
                                            <dl class="arm_selectbox column_level_dd arm_width_200">
                                                <dt><span><?php echo ($get_action == 'edit_profile' ) ? $options[$key]['font_family'] : 'Poppins' ?></span><input type="text" style="display:none;" value="" class="arm_autocomplete" readonly="readonly"  /><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                                <dd>
            ...
            <div class="arm_custom_css_popup_wrapper">
                <div class="arm_custom_css_popup_inner_wrapper">
                    ...
                    <div class="arm_custom_css_popup_container">
                        <textarea class="arm_codemirror_field arm_width_500" id="arm_codemirror_field" name="template_options[custom_css]" cols="10" rows="6" ><?php echo isset($options['custom_css']) ? stripslashes($options['custom_css']) : ''; ?></textarea>
                    </div>
                ...
                <style type="text/css" id='arm_profile_template_custom_css'><?php echo isset($options['custom_css']) ? stripslashes($options['custom_css']) : ''; ?></style>
            </div>
        </form>
