						...
						<tr class="arm_drip_custom_content_opts" style="display:none;">
							...
							<td>
								<div class="arm_drip_custom_content_shortcode">
                            		...
                            		<pre>    <?php _e('Put Your Restricted Content Message Here.', 'ARMember'); ?></pre>
						...
						<tr>
							...
							<td>
								...
								<div class="arm_drip_type_options_wrapper arm_drip_wrapper_immediate">
									...
									<label for="arm_drip_expiration_immediate"><?php _e('Enable Expiration','ARMember')?></label>
									...
									<div class="arm_drip_expire_after_immediate hidden_section">
										<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
										<input type="number" id="arm_drip_type_exp_days" name="rule_options[expire_immediate_days]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
										...
										<label><?php _e('at', 'ARMember');?>&nbsp;</label>
										...
										<dl class="arm_selectbox column_level_dd arm_drip_type_time">
											...
											<dd>
												<ul data-id="arm_drip_type_exp_time">
													<?php for($i=0; $i<24 ; $i++)
													{?>
														<li data-label="<?php echo sprintf("%02d", $i).":00"?>" data-value="<?php echo sprintf("%02d", $i).":00"?>"><?php echo sprintf("%02d", $i).":00"?></li>
													<?php }?>
												</ul>
											</dd>
										</dl>
								...
								<div class="arm_drip_type_options_wrapper arm_drip_type_options_days hidden_section arm_required_wrapper" id="arm_drip_type_options_days">
									...
									<div class="arm_drip_type_options_container">
										...
										<label for="arm_drip_expiration_days"><?php _e('Enable Expiration', 'ARMember')?></label>
										<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_html("When enable the expiration for dripped content then allowed access will be restricted as per the expiration settings. Expiration of the dripped content will be calculated time period after the content is dripped to the member.", 'ARMember');?>"></i>
										<div class="arm_drip_expire_after_days hidden_section">
											<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
											<input type="number" id="arm_drip_type_exp_days" name="rule_options[expire_days]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
								...
								<div class="arm_drip_type_options_wrapper arm_drip_type_options_post_publish hidden_section arm_required_wrapper" id="arm_drip_type_options_post_publish">
									...
									<div class="arm_drip_type_options_container">
										...
										<label for="arm_drip_type_expire_post_publish"><?php _e('Enable Expiration', 'ARMember')?></label>
										<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_html("When enable the expiration for dripped content then allowed access will be restricted as per the expiration settings. Expiration of the dripped content will be calculated time period after the content is dripped to the member.", 'ARMember');?>"></i>
										<div class="arm_drip_expire_post_publish hidden_section">
											<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
											<input type="number" id="arm_edit_drip_type_post_publish_add" name="rule_options[exp_post_publish]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
								...
								<div class="arm_drip_type_options_wrapper arm_drip_type_options_post_modify hidden_section arm_required_wrapper" id="arm_drip_type_options_post_modify">
									...
									<div class="arm_drip_type_options_container">
										...
										<label for="arm_drip_type_expire_post_modify"><?php _e('Enable Expiration', 'ARMember')?></label>
										<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_html("When enable the expiration for dripped content then allowed access will be restricted as per the expiration settings. Expiration of the dripped content will be calculated time period after the content is dripped to the member.", 'ARMember');?>"></i>
										<div class="arm_drip_expire_post_modify hidden_section">
											<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
											<input type="number" id="arm_edit_drip_type_post_modify_add" name="rule_options[exp_post_modify]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
						...
						<tr>
							...
							<td>
								...
								<div class="arm_drip_type_options_wrapper arm_edit_drip_wrapper_immediate hidden_section" id="arm_edit_drip_type_options_instant">
									...
									<label for="arm_edit_drip_expiration_immediate"><?php _e('Enable Expiration','ARMember')?></label>
									<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_html("When enable the expiration for dripped content then allowed access will be restricted as per the expiration settings. Expiration of the dripped content will be calculated time period after the content is dripped to the member.", 'ARMember');?>"></i>
									<div class="arm_edit_drip_expire_after_immediate hidden_section">
										<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
										<input type="number" id="arm_drip_edit_type_exp_imm" name="rule_options[expire_immediate_days]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
								...
								<div class="arm_drip_type_options_wrapper arm_edit_drip_type_options_days hidden_section arm_required_wrapper" id="arm_edit_drip_type_options_days">
									...
									<label for="arm_drip_edit_expiration_days"><?php _e('Enable Expiration', 'ARMember')?></label>
									<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_html("When enable the expiration for dripped content then allowed access will be restricted as per the expiration settings. Expiration of the dripped content will be calculated time period after the content is dripped to the member.", 'ARMember');?>"></i>
									<div class="arm_edit_drip_expire_after_days hidden_section">
											<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
											<input type="number" id="arm_edit_drip_exp_days" name="rule_options[expire_days]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
								...
								<div class="arm_drip_type_options_wrapper arm_edit_drip_type_options_post_publish hidden_section arm_required_wrapper" id="arm_edit_drip_type_options_post_publish">
									...
									<div class="arm_drip_type_options_container">
										...
										<label for="arm_drip_edit_expire_post_publish"><?php _e('Enable Expiration', 'ARMember')?></label>
										<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_html("When enable the expiration for dripped content then allowed access will be restricted as per the expiration settings. Expiration of the dripped content will be calculated time period after the content is dripped to the member.", 'ARMember');?>"></i>
										<div class="arm_edit_drip_expire_post_publish hidden_section">
											<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
											<input type="number" id="arm_edit_drip_exp_post_publish" name="rule_options[exp_post_publish]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
								...
								<div class="arm_drip_type_options_wrapper arm_edit_drip_type_options_post_modify hidden_section arm_required_wrapper" id="arm_edit_drip_type_options_post_modify">
									...
									<div class="arm_drip_type_options_container">
										...
										<label for="arm_drip_edit_expire_post_modify"><?php _e('Enable Expiration', 'ARMember')?></label>
										<i class="arm_helptip_icon armfa armfa-question-circle" title="<?php echo esc_html("When enable the expiration for dripped content then allowed access will be restricted as per the expiration settings. Expiration of the dripped content will be calculated time period after the content is dripped to the member.", 'ARMember');?>"></i>
										<div class="arm_edit_drip_expire_post_modify hidden_section">
											<label class="arm_hide_after_drip"><?php _e('Hide After', 'ARMember');?></label>
											<input type="number" id="arm_edit_drip_exp_post_modify" name="rule_options[exp_post_modify]" min="0" value="10" data-msg-required="<?php _e('Please enter days.', 'ARMember');?>" onkeydown="javascript:return checkNumber(event)"/>
