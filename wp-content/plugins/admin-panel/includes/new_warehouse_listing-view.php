...
<a class="back btn btn-primary" href="<?php echo admin_url('admin.php?page=new_warehouse_listing');?>">Back</a>
    </div>
    ...
    <form class="p-2 row" id="update_warehouse_form" class="update_form" name="update_warehouse" method="post" enctype='multipart/form-data'>
<?php //echo get_the_content($post_id); ?>
 ...
 <div class="col-12 col-md-6 my-2">
   ...
   <input class="form-control" type="" name="phone_number" maxlength="15" minlength="10" placeholder="Phone Number" onkeypress="return isNumber(event)" value="<?php echo ($phone_number?$phone_number:''); ?>">
 </div>
 <div class="col-12 col-md-6 my-2">
...
<div class="col-12 col-md-12 my-2">
 ...
 <div class="col-12 col-md-4 my-2">
  ...
  <!-- <input class="form-control" type="" name="State" placeholder="State" value="<?php echo ($state?$state:''); ?>">
</div> -->
<div class="col-12 col-md-4 my-2">
...
<div class="col-12">
    <h4 class="blue-heading mt-4">2. Business Description</h4>
  </div>
<div class="col-12 col-md-12 my-2">
<?php //echo get_the_content($post_id);
...
<div class="col-12">
  <h4 class="blue-heading mt-4">3. Additional Details</h4>
</div>

<div class="col-12 col-md-6 my-2">
 <?php $parking_space = get_post_meta($post_id,'parking_space',true);?>
<label>Parking Space (Number of parking spots)</label>
 <input class="form-control" type="" name="parking_space" placeholder="Parking Space" value="<?php echo ($parking_space?$parking_space:''); ?>" onselectstart="return false" onpaste="return false;"  autocomplete=off onkeypress="return isNumber(event)">
</div>
<div class="col-12 col-md-6 my-2">
 <?php $clear_height = get_post_meta($post_id,'clear_height',true);?>
<label>Clear height (feet)</label>
 <input class="form-control" type="" name="clear_height" placeholder="Clear height" value="<?php echo ($clear_height?$clear_height:''); ?>" onselectstart="return false" onpaste="return false;"  autocomplete=off onkeypress="return isNumber(event)">
</div>
<div class="col-12 col-md-6 my-2">
 <?php $dock_doors = get_post_meta($post_id,'dock_doors',true);?>
  <label>Dock Doors ( number of dock)</label>
 <input class="form-control" type="" name="dock_doors" placeholder="Dock Doors" onkeypress="return isNumber(event)" value="<?php echo ($dock_doors?$dock_doors:''); ?>" onselectstart="return false" onpaste="return false;"  autocomplete=off onkeypress="return isNumber(event)">
</div>
...
<input class="form-control" type="" name="map" placeholder="Google Map Location" value="<?php// echo ($map?$map:''); ?>">
 ...
 <div class="col-12">
   <h4 class="blue-heading mt-4">4. Service, Cert. Commodity, Additional Services and Capacity Sq. ft.</h4>
 </div>
 ...
 <label>Commodity</label>
    <input class="services_select" value="Commodity" readonly>
                <div class="services_options checkbox-btn">
                   ...
                   <?php if(isset($datac) && !empty($datac)){
                    foreach ($data as $data_term) { 
...
// }
 ...
 <label>Capacity Sq. ft.(Number in Sq. Ft.)</label>
  ...
  <div class="col-12">
    <h4 class="blue-heading mt-4">5. Speciality Services</h4>
  </div>
  <div class="col-12 col-md-12 my-2">
<?php //echo get_the_content($post_id); ?>
...
<div class="col-12">
 <h4 class="blue-heading mt-4">6.  Logos and Photos</h4>
</div>
<div class="col-12 col-md-6 my-2">
  <!-- <label>Company Logo</label> -->
<input class="form-control" type="file" name="upload_file" id="logo" accept="image/*">
 ...
 <div class="col-12 col-md-6 my-2">
        <!-- <label class="form-label upload-image-label" for="inputEmail">Photos to show your warehouse outside and inside -->
          <input type="file" class="upload-image-input" id="files" name="image[]" accept="image/*" multiple>
        <!-- </label> -->
                        ...
                        for( $i = 0; $i < count( $gallery_data['image_url'] ); $i++ ){
                            ...
                            <div class="gallery_single_row dolu">
                              <div class="gallery_area image_container ">
                                <img class="gallery_img_img" src="<?php esc_html_e( $gallery_data['image_url'][$i] ); ?>" height="65" width="65"/>
                                <input type="hidden"
...
<ol id="myFiless"></ol>
                 <div class="content w-100 d-grid">
               <p class="text-center mt-3">Upload a new Photo. Minimum dimensions should be 400px x 400 px, Larger image will be resized automatically.</p>
...
<?php
       ...
       ?>
 <div class="d-flex align-items-center justify-content-between">
  <h2 class="blue-heading">Manage Warehouse Business</h2>
...
<div class="bg-white p-0 rounded listing_table mt-4">  
   <!--  <div class="warehouse_searching d-flex pb-3 align-items-center">
        <input type="text" id="warehouse-search" name="warehouse_list" class=""  placeholder="Search warehouse"  onkeyup="enable_search_btn()">
        <button class="custom-btn search-btn search-input-btn btn btn-primary ms-3" onclick="filter_function()" disabled="disabled">Search</button> 
    </div> -->
      <table id="warehouse_entery" class="warehous_list mt-4 pt-0 d-inline-block">
   <thead>
     <tr>
      <th>S no</th>
      <th>Warehouse ID</th>
   ...
   <?php if ($query->have_posts()) {
        ...
        <tr>
         ...
         <td><?php //echo $author_id;
          ...
          echo admin_url("admin.php?page=new_warehouse_listing&warehouse_id=");
          echo get_the_ID();
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
         ...
         "parent" => 0,
          ...
          <div class="form_moredetail p-2 viewmore_detail">
            <form class="row" id="add_warehouse_form" name="new_warehouse" method="post" enctype='multipart/form-data' >
              ...
              <div class="col-12 col-md-6 my-2">
                <input class="form-control" type="" name="phone_number" maxlength="15" minlength="10" placeholder="Phone Number" onkeypress="return isNumber(event)" required>
              </div>
               <div class="col-12 col-md-6 my-2">
                <input class="form-control" type="" name="email_address" placeholder="Email Address" value="<?php echo $userEmail;?>" required>
              </div>
               <div class="col-12 col-md-6 my-2">
  ...
  <?php }?>
             ...
             <h4 class="blue-heading mt-4">2. Business Description</h4>
              ...
              <div class="col-12">
                <h4 class="blue-heading mt-3">3. Additional Details</h4>
              </div>
               <div class="col-12 col-md-6 my-2">
                <input class="form-control" type="" name="parking_space" placeholder="Parking Space (Number of parking spots)" onselectstart="return false" onpaste="return false;"  autocomplete=off onkeypress="return isNumber(event)">
              </div>
              <div class="col-12 col-md-6 my-2">
...
<div class="col-12">
                 <h4 class="blue-heading mt-4">6. Logo and Photos</h4>
              </div>
         <div class="col-12 col-md-6 my-2">
                <!-- <label class="form-label upload-image-label warehouse_logo" for="inputEmail">Upload Photo </label> -->
                  <input type="file" class="addlist_logo" name="upload_file" id="logo" accept="image/*">
               <div class="mt-3" id="logo_wrapper">
                <div id="logo_box_container">   
                </div>
            </div>
      ...
      <div class="col-12 col-md-6 my-2">
        <!-- <label class="form-label upload-image-label" for="inputEmail">Upload New Photo</label> -->
          <input type="file" class="addlist_upload-imageinput" id="files" name="image[]" accept="image/*" multiple>
          <div class="mt-3" id="gallery_wrapper">
                <div id="img_box_container">
                           <ol class="p-0 m-0" id="myFiless"></ol> 
            </div>                                              
        </div>
      </div>
       <div class="col-12 col-md-12 my-2">
      ...
      <div class="col-12 textright mt-4">
        <input class="form-control" type="hidden" name="action" value="add_warehouse" />
...
//     jQuery('#warehouse_enterys').DataTable({
//        "order": [[ 0, "asc" ]],
//         "pageLength" : 10,
//     });
// } );
jQuery('.popup-cls-btn').on('click',function(){
    ...
    jQuery('#warehouse_entery').load(document.URL + ' #warehouse_entery');
...
jQuery('#specialty-textarea').keyup(function() {
 ...
 // if (window.File && window.FileList && window.FileReader) {
            var filesToUpload = []; // Array to store files
                  ...
                  document.getElementById("myFiless").innerHTML += `<li><button onclick="removeFile('${filesToUpload[i].FID}')">X</button><img style="width: 65px; height: 65px;" src="${e.target.result}" class="prescriptions"></li>`;
    ...
    if(post_name.length > 0){
      ...
      jQuery.ajax({
        ...
        success: function(response){  
          ...
          jQuery("#notification").addClass(dataresponse['board']['status']);
          jQuery("#notification").html(dataresponse['board']['msg']); 
         // jQuery("#manage_warehouse").load(location.href + " #manage_warehouse"); 
          //jQuery('#manage_warehouse').load(document.URL + ' #manage_warehouse');
          jQuery('.create_btn').attr("disabled", false);
           location.reload();
...
function enable_search_btn(){
    var input_field = jQuery('#warehouse-search').val();
...
function filter_function(){
        ...
        jQuery.ajax({
            ...
            url: "<?php echo admin_url('admin-ajax.php'); ?>",
            data: {
                action: 'warehouse_filter',          
                input: jQuery('#warehouse-search').val(),
            },
            beforeSend: function() {
                add_loader(".warehouse_searching");
            },
            success: function(res) {
                remove_loader(".warehouse_searching");    
                jQuery(".warehous_list tbody" ).html(res);        
        ...
        jQuery(document).ready(function() {
        jQuery('#warehouse_entery').DataTable({
        // "searching": false,
        // "bPaginate": false,
        // "bFilter": false,
         "order": [[ 0, "asc" ]],
