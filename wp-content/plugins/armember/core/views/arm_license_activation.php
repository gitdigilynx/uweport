...
<div class="wrap arm_page arm_feature_settings_main_wrapper">
    <div class="content_wrapper arm_feature_settings_content" id="content_wrapper">
        ...
        <form method="post" action="#" id="arm_global_settings" class="arm_global_settings arm_admin_form"
            ...
            if ($setact == 1 && $is_debug_enable == 0) 
            {
                ...
                <table class="form-table">
                    ...
                    { ?>
                        <tr class="form-field">
                            <th class="arm-form-table-label"><label class="lblsubtitle" style="font-weight:bold;font-size:16px;margin-left:0px;"><?php _e('Activation Information:', 'ARMember') ?>&nbsp;&nbsp;</label>
                            </th>
                            <td class="arm-form-table-content">&nbsp;
        ...
        <?php
            ...
            echo apply_filters( 'arm_addon_license_content_external', $arm_license_addon_content);
        ?>
    </div>
