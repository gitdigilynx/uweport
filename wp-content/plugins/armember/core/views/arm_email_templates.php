...
$message_types = array(
    ...
    'on_purchase_subscription_bank_transfer' => __('On Purchase membership plan using Bank Transfer','ARMember'),
						...
						<tr class="arm_message_tr_<?php echo $messageID;?> row_<?php echo $messageID;?>">
							...
							switch ($rc->arm_message_type)
							{
								...
								case 'on_purchase_subscription_bank_transfer':
                                    $msge_type = __('On Purchase membership plan using Bank Transfer', 'ARMember');
									break;
								default:
		...
		<table cellspacing="0">
			<tr class="popup_wrapper_inner">	
				...
				<td class="popup_content_text">
					...
					<div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Plan Description", 'ARMember'); ?>">
					...
					<div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Plan Expire Date", 'ARMember'); ?>">
                    ...
                    <div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Subscription Next Due Date", 'ARMember'); ?>">
					    <span class="arm_variable_code arm_communication_email_code arm_no_bank_notification" data-code="{ARM_MESSAGE_SUBSCRIPTION_NEXT_DUE}" ><?php _e("Plan Next Due Date", 'ARMember'); ?></span>
					</div>
                    <div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Plan Amount", 'ARMember'); ?>">
					...
					<div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Payment Type", 'ARMember'); ?>">
					...
					<div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Payment Gateway", 'ARMember'); ?>">
					...
					<div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Subscription Expire Date", 'ARMember'); ?>">
					...
					<div class="arm_shortcode_row armhelptip arm_no_bank_notification" title="<?php _e("Display Subscription Amount", 'ARMember'); ?>">
