...
<div class="wrap arm_page arm_manage_form_main_wrapper">
    <div id="content_wrapper" class="arm_manage_form_content_wrapper">
        <form id="arm_manage_form_settings_form" class="arm_admin_member_form <?php echo $form_class; ?>">
            ...
            <?php $arm_new_set_name = !empty($get_set_name) ? stripslashes_deep( esc_attr($get_set_name) ) : ''; ?>
            ...
            if ($isRegister || $isEditProfile) {
                ...
                ?>
                <input type="hidden" name="arm_new_set_name" id="arm_new_set_name" value="<?php echo esc_attr($arm_new_set_name); ?>" />
                <?php
            } else {
                ...
                <div class="page_title">
                    <?php if ($isRegister || $isEditProfile) { ?>
                        ...
                        <div class="arm_header_registration_form_title">
                            <?php echo stripslashes_deep($form_label = (sanitize_text_field( $get_action) !== 'new_form') ? stripslashes_deep($form_detail['arm_form_label']) : stripslashes_deep(esc_html( $arm_new_set_name ) ) ); ?>
                            <input type="hidden" name="arm_forms[<?php echo esc_attr($get_form_id); ?>][arm_form_label]"  class="arm-df__field-label_value" value="<?php echo stripslashes_deep($form_label); ?>"/>
                        </div>
                    <?php } else { ?>
                    ...
                    <?php if ($isRegister || $isEditProfile) { ?>
                        <div class="arm_form_shortcode_container" style="<?php echo (sanitize_text_field( $get_action) == 'new_form') ? 'display:none;' : ''; ?>" >
                        ...
                        <?php if (!empty($otherForms)) { ?>
                            ...
                            <?php foreach ($otherForms as $oform) { ?>
                                <div class="arm_editor_form_fileds_wrapper armPageContainer">
                                    ...
                                    if (sanitize_text_field($get_action) == 'new_form') {
                        ...
                        <div class="tab arm_form_settings_styles_container arm_width_100_pct" id="arm_form_settings_styles_container" >
                            <div id="tabsetting-1" class="arm-tab-content">
                                ...
                                <?php if (!$isRegister && !$isEditProfile) { ?>
                                    ...
                                    $forgotgePassMsg = isset($otherFormIDs['forgot_password']['arm_form_settings']['message']) ? stripslashes($otherFormIDs['forgot_password']['arm_form_settings']['message']) : __('We have sent you password reset link, Please check your mail.', 'ARMember');
