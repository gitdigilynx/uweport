...
$arm_default_invoice_template .= '<div class="ms-invoice-details ms-status-paid">';
        ...
        function arm_update_all_settings() {
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'arm_update_access_restriction_settings') {
                ...
                $new_general_settings['arm_allow_drip_expired_plan'] = isset($_POST['arm_general_settings']['arm_allow_drip_expired_plan']) ? intval($_POST['arm_general_settings']['arm_allow_drip_expired_plan']) : 0;

                $new_general_settings['arm_allow_drip_expired_plan_is_sync'] = isset($_POST['arm_general_settings']['arm_allow_drip_expired_plan_is_sync']) ? intval($_POST['arm_general_settings']['arm_allow_drip_expired_plan_is_sync']) : 0;

                $new_general_settings['arm_drip_restrict_old_posts'] = isset($_POST['arm_general_settings']['arm_drip_restrict_old_posts']) ? intval($_POST['arm_general_settings']['arm_drip_restrict_old_posts']) : 0;
