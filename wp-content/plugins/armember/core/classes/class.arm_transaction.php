							...
							<div class="popup_content_text arm_transactions_detail_popup_text">
								<table width="100%" cellspacing="0">
									...
									<tr>
										...
										<td><?php echo number_format((float) $extra_vars['trial']['amount'], $arm_currency_decimal).' '.strtoupper($log_detail['arm_currency']);?></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><?php
											...
											{ 
												echo number_format((float) $log_detail['arm_coupon_discount'], $arm_currency_decimal);
